...
class DeliveryCity implements DeliveryCityModelInterface
{
	...
	{
		return \api\modules\regular\models\DeliveryCity::POI_TYPE;
	}
	...
	public function getPoiRepository(): PoiRepositoryInterface
	{
		...
		if ($repository === null) {
			...
			$repository = Yii::$app->ecommerce->getDeliveryCityRepository();
		}
	...
	{
		return \api\modules\regular\models\DeliveryCity::AREA_RADIUS;
	}
